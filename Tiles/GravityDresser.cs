...
{
	public class GravityDresser : ModTile
	{
		public override void SetDefaults()
		{
			...
			name.SetDefault("Gravity Dresser");
			AddMapEntry(new Color(255, 206, 49), name);
			dustType = 162;
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Gravity Dresser";
			dresserDrop = ItemType<Items.Placeables.GravityDresser>();
		}
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.showItemIcon2 = ItemType<Items.Placeables.GravityDresser>();
