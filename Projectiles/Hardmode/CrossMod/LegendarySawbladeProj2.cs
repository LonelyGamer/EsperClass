...
{
    public class LegendarySawbladeProj2 : ECProjectile
    {
		...
		//Based on Loot Bags mod's LegendaryStaffProj
        ...
        public override bool PreKill(int timeLeft)
        {
			...
			{
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("LBLegendaryExplosion"), projectile.damage, 0, Main.myPlayer, 0f, 0f);
